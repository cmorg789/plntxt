...
def upgrade() -> None:
    ...
    op.execute("""
        ...
        ('agent_schedule', '{"writer": "0 8,14,20 * * *", "responder": "*/15 * * * *", "moderator": "*/15 * * * *", "consolidator": "0 3 * * 0"}'),
